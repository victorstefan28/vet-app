...
function AppointmentDetails({ appointment, setAppointment }: AppointmentProps) {
  ...
  return (
    ...
    >
      <Typography variant="h6">Date pacient</Typography>

      {[
        { label: "Nume pacient", value: appointment.pet.name, key: "name" },
        {
          label: "Specie si rasa",
      ...
      <Accordion defaultExpanded>
        <AccordionSummary expandIcon={<ExpandMoreIcon />}>
          <Typography>Detalii proprietar</Typography>
        </AccordionSummary>
        <AccordionDetails>
          {[
            { label: "Nume", value: appointment.ownerName, key: "ownerName" },
            {
              label: "Telefon",
